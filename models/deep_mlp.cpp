...
{
    ctx.add(new RamTensor<float>(), "zscore_eightbit/Variable_1__port__0/reshape:0");
...
{   
    ...
    ctx.add(out_tensor, "zscore_eightbit/Variable_1__port__0/min:0");
    ctx.push(new MinOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "zscore_eightbit/Variable_1__port__0/max:0");
    ctx.push(new MaxOp(), 
             { "zscore_eightbit/Variable_1__port__0/reshape:0", "zscore_eightbit/Variable_1__port__0/reduction_dims:0" },
             { "zscore_eightbit/Variable_1__port__0/max:0" });
}
{
    ctx.add(new RamTensor<uint8_t>(), "zscore_eightbit/Variable_1__port__0/quantize:0");
    ctx.add(new RamTensor<float>({1}), "zscore_eightbit/Variable_1__port__0/quantize:1");
    ctx.add(new RamTensor<float>({1}), "zscore_eightbit/Variable_1__port__0/quantize:2");
...
{
    ctx.add(new RamTensor<float>(), "logits_eightbit/Variable_5__port__0/reshape:0");
    ctx.push(new ReshapeOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "logits_eightbit/Variable_5__port__0/min:0");
    ctx.push(new MinOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "logits_eightbit/Variable_5__port__0/max:0");
    ctx.push(new MaxOp(), 
             { "logits_eightbit/Variable_5__port__0/reshape:0", "logits_eightbit/Variable_5__port__0/reduction_dims:0" },
             { "logits_eightbit/Variable_5__port__0/max:0" });
}
{
    ctx.add(new RamTensor<uint8_t>(), "logits_eightbit/Variable_5__port__0/quantize:0");
    ctx.add(new RamTensor<float>({1}), "logits_eightbit/Variable_5__port__0/quantize:1");
    ctx.add(new RamTensor<float>({1}), "logits_eightbit/Variable_5__port__0/quantize:2");
    ctx.push(new QuantizeV2Op(),
...
{
    ctx.add(new RamTensor<float>(), "MatMul_eightbit/x__port__0/reshape:0");
    ctx.push(new ReshapeOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "MatMul_eightbit/x__port__0/max:0");
    ctx.push(new MaxOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "MatMul_eightbit/x__port__0/min:0");
    ctx.push(new MinOp(), 
             { "MatMul_eightbit/x__port__0/reshape:0", "MatMul_eightbit/x__port__0/reduction_dims:0" },
             { "MatMul_eightbit/x__port__0/min:0" });
}
{
    ctx.add(new RamTensor<uint8_t>(), "MatMul_eightbit/x__port__0/quantize:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_eightbit/x__port__0/quantize:1");
    ctx.add(new RamTensor<float>({1}), "MatMul_eightbit/x__port__0/quantize:2");
    ctx.push(new QuantizeV2Op(),
...
{
    ctx.add(new RamTensor<float>(), "MatMul_2_eightbit/Variable_4__port__0/reshape:0");
    ctx.push(new ReshapeOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "MatMul_2_eightbit/Variable_4__port__0/max:0");
    ctx.push(new MaxOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "MatMul_2_eightbit/Variable_4__port__0/min:0");
    ctx.push(new MinOp(), 
             { "MatMul_2_eightbit/Variable_4__port__0/reshape:0", "MatMul_2_eightbit/Variable_4__port__0/reduction_dims:0" },
             { "MatMul_2_eightbit/Variable_4__port__0/min:0" });
}
{
    ctx.add(new RamTensor<uint8_t>(), "MatMul_2_eightbit/Variable_4__port__0/quantize:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_2_eightbit/Variable_4__port__0/quantize:1");
    ctx.add(new RamTensor<float>({1}), "MatMul_2_eightbit/Variable_4__port__0/quantize:2");
    ctx.push(new QuantizeV2Op(),
...
{
    ctx.add(new RamTensor<float>(), "zscore_1_eightbit/Variable_3__port__0/reshape:0");
    ctx.push(new ReshapeOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "zscore_1_eightbit/Variable_3__port__0/min:0");
    ctx.push(new MinOp(), 
...
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "zscore_1_eightbit/Variable_3__port__0/max:0");
    ctx.push(new MaxOp(), 
             { "zscore_1_eightbit/Variable_3__port__0/reshape:0", "zscore_1_eightbit/Variable_3__port__0/reduction_dims:0" },
             { "zscore_1_eightbit/Variable_3__port__0/max:0" });
}
{
    ctx.add(new RamTensor<uint8_t>(), "zscore_1_eightbit/Variable_3__port__0/quantize:0");
    ctx.add(new RamTensor<float>({1}), "zscore_1_eightbit/Variable_3__port__0/quantize:1");
    ctx.add(new RamTensor<float>({1}), "zscore_1_eightbit/Variable_3__port__0/quantize:2");
    ctx.push(new QuantizeV2Op(),
...
}
{
    ...
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit:2");
...
{
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit/requant_range:0");
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit/requant_range:1");
    ctx.push(new Requantization_RangeOp(),
             { "MatMul/eightbit:0", "MatMul/eightbit:1", "MatMul/eightbit:2" },
             { "MatMul/eightbit/requant_range:0", "MatMul/eightbit/requant_range:1" });
}
{   
    ctx.add(new RamTensor<uint8_t>(), "MatMul/eightbit/requantize:0");
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit/requantize:1");
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit/requantize:2");
...
{
    ctx.add(new RamTensor<int>(), "zscore/eightbit:0");
    ctx.add(new RamTensor<float>({1}), "zscore/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "zscore/eightbit:2");
...
{
    ctx.add(new RamTensor<float>({1}), "zscore/eightbit/requant_range:0");
    ctx.add(new RamTensor<float>({1}), "zscore/eightbit/requant_range:1");
    ctx.push(new Requantization_RangeOp(),
             { "zscore/eightbit:0", "zscore/eightbit:1", "zscore/eightbit:2" },
             { "zscore/eightbit/requant_range:0", "zscore/eightbit/requant_range:1" });
}
{   
    ctx.add(new RamTensor<uint8_t>(), "zscore/eightbit/requantize:0");
    ctx.add(new RamTensor<float>({1}), "zscore/eightbit/requantize:1");
    ctx.add(new RamTensor<float>({1}), "zscore/eightbit/requantize:2");
    ctx.push(new RequantizeOp(),
...
{
    ctx.add(new RamTensor<int>(), "MatMul_1/eightbit:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_1/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "MatMul_1/eightbit:2");
    ctx.push(new QntMatMulOp<uint8_t, uint8_t, int>(), 
...
{
    ctx.add(new RamTensor<float>({1}), "MatMul_1/eightbit/requant_range:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_1/eightbit/requant_range:1");
    ctx.push(new Requantization_RangeOp(),
             { "MatMul_1/eightbit:0", "MatMul_1/eightbit:1", "MatMul_1/eightbit:2" },
             { "MatMul_1/eightbit/requant_range:0", "MatMul_1/eightbit/requant_range:1" });
}
{   
    ctx.add(new RamTensor<uint8_t>(), "MatMul_1/eightbit/requantize:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_1/eightbit/requantize:1");
    ctx.add(new RamTensor<float>({1}), "MatMul_1/eightbit/requantize:2");
    ctx.push(new RequantizeOp(),
...
{
    ctx.add(new RamTensor<int>(), "zscore_1/eightbit:0");
    ctx.add(new RamTensor<float>({1}), "zscore_1/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "zscore_1/eightbit:2");
    ctx.push(new QuantizedAddOp<uint8_t, uint8_t, int>(), 
...
{
    ctx.add(new RamTensor<float>({1}), "zscore_1/eightbit/requant_range:0");
    ctx.add(new RamTensor<float>({1}), "zscore_1/eightbit/requant_range:1");
    ctx.push(new Requantization_RangeOp(),
             { "zscore_1/eightbit:0", "zscore_1/eightbit:1", "zscore_1/eightbit:2" },
             { "zscore_1/eightbit/requant_range:0", "zscore_1/eightbit/requant_range:1" });
}
{   
    ctx.add(new RamTensor<uint8_t>(), "zscore_1/eightbit/requantize:0");
    ctx.add(new RamTensor<float>({1}), "zscore_1/eightbit/requantize:1");
    ctx.add(new RamTensor<float>({1}), "zscore_1/eightbit/requantize:2");
    ctx.push(new RequantizeOp(),
...
{
    ctx.add(new RamTensor<int>(), "MatMul_2/eightbit:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_2/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "MatMul_2/eightbit:2");
    ctx.push(new QntMatMulOp<uint8_t, uint8_t, int>(), 
...
{
    ctx.add(new RamTensor<float>({1}), "MatMul_2/eightbit/requant_range:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_2/eightbit/requant_range:1");
    ctx.push(new Requantization_RangeOp(),
             { "MatMul_2/eightbit:0", "MatMul_2/eightbit:1", "MatMul_2/eightbit:2" },
             { "MatMul_2/eightbit/requant_range:0", "MatMul_2/eightbit/requant_range:1" });
}
{   
    ctx.add(new RamTensor<uint8_t>(), "MatMul_2/eightbit/requantize:0");
    ctx.add(new RamTensor<float>({1}), "MatMul_2/eightbit/requantize:1");
    ctx.add(new RamTensor<float>({1}), "MatMul_2/eightbit/requantize:2");
    ctx.push(new RequantizeOp(),
...
{
    ctx.add(new RamTensor<int>(), "logits/eightbit:0");
    ctx.add(new RamTensor<float>({1}), "logits/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "logits/eightbit:2");
    ctx.push(new QuantizedAddOp<uint8_t, uint8_t, int>(), 
...
{
    ctx.add(new RamTensor<float>({1}), "logits/eightbit/requant_range:0");
    ctx.add(new RamTensor<float>({1}), "logits/eightbit/requant_range:1");
    ctx.push(new Requantization_RangeOp(),
             { "logits/eightbit:0", "logits/eightbit:1", "logits/eightbit:2" },
             { "logits/eightbit/requant_range:0", "logits/eightbit/requant_range:1" });
}
{   
    ctx.add(new RamTensor<uint8_t>(), "logits/eightbit/requantize:0");
    ctx.add(new RamTensor<float>({1}), "logits/eightbit/requantize:1");
    ctx.add(new RamTensor<float>({1}), "logits/eightbit/requantize:2");
    ctx.push(new RequantizeOp(),
...
{
    ctx.add(new RamTensor<float>(), "logits:0");
